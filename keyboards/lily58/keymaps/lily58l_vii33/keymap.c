...
[_QWERTY] = LAYOUT(
  ...
  CC_APHO,  KC_Y,   KC_X,  KC_C,     KC_V,   KC_B,  KC_MUTE,       MUTE_MI,  KC_N,    KC_M,   CC_SCOLN, CC_COLN, CC_EXLM, KC_ENTER, 
...
[_LOWER] = LAYOUT(
  ...
  XXXXXXX,  KC_BSPC, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT,                       XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT,  KC_PGDN, XXXXXXX, 
